...
public class Debris_Spawner : MonoBehaviour
{
    ...
    void spawnDebris()
    {
        ...
        for (int i = 0; i < amount; i++)
        {
            ...
            //spawn
            Instantiate(debris_type, new Vector2(Random.Range(player_position.x + 50, player_position.x + 90), Random.Range(player_position.y - boundry, player_position.y + boundry)), transform.rotation);
        }
    }
}
